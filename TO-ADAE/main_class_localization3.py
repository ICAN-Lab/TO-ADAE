...
Fix_s1,Fix_s1_train,Fix_s1_test=take_data("s/Fix/new1_Fix_200s_1.csv")
Fix_s2,Fix_s2_train,Fix_s2_test=take_data("s/Fix/new2_Fix_200s_1.csv")
Fix_s3,Fix_s3_train,Fix_s3_test=take_data("s/Fix/new3_Fix_200s_1.csv")

Fix_e1,Fix_e1_train,Fix_e1_test=take_data("e/Fix/new1_Fix_200e_1.csv")
Fix_e2,Fix_e2_train,Fix_e2_test=take_data("e/Fix/new2_Fix_200e_1.csv")
Fix_e3,Fix_e3_train,Fix_e3_test=take_data("e/Fix/new3_Fix_200e_1.csv")

print(Fix_s1_train.shape, Fix_s1_test.shape)
print(Fix_s2_train.shape, Fix_s2_test.shape)
print(Fix_s3_train.shape, Fix_s3_test.shape)
...
######################################################################
UAV_e1,UAV_e1_train,UAV_e1_test=take_data("e/UAV/new1_UAV_200e_1.csv")
UAV_e2,UAV_e2_train,UAV_e2_test=take_data("e/UAV/new2_UAV_200e_1.csv")
UAV_e3,UAV_e3_train,UAV_e3_test=take_data("e/UAV/new3_UAV_200e_1.csv")

UAV_s1,UAV_s1_train,UAV_s1_test=take_data("s/UAV/new1_UAV_200s_1.csv")
UAV_s2,UAV_s2_train,UAV_s2_test=take_data("s/UAV/new2_UAV_200s_1.csv")
UAV_s3,UAV_s3_train,UAV_s3_test=take_data("s/UAV/new3_UAV_200s_1.csv")
